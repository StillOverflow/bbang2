...
<template>
  <div class="py-4 container-fluid">
    ...
    <div class="card mt-3" v-show="isDefect">
      ...
      <div class="row card-body">
        ...
        <div class="form-check col-8 col-md-3 d-flex align-items-center justify-content-start">
          <input class="form-check-input ms-1 ms-xl-3" type="radio" v-model="def_status" value="재투입" id="defRepeat" :disabled="isDefCompleted">
          <label class="form-check-label ms-2 me-xl-4 mt-2 text-start" for="defRepeat" :style="t_overflow">
            재투입
          </label>
          <input class="form-check-input ms-3" type="radio" v-model="def_status" value="폐기" id="defDispose" :disabled="isDefCompleted">
        ...
        <div class="col-8 col-md-2 mb-2">
          <input type="datetime-local" class="form-control" v-model="complete_dt" :disabled="isDefCompleted">
        </div>
        ...
        <div class="col-5 col-md-2 mb-2">
          <select class="form-select" v-model="complete_id" :disabled="isDefCompleted">
            <option :value="null" disabled hidden>선택</option>
            <option v-for="(mem) in members" :key="mem.id" :value="mem.id">{{ mem.name }}</option>
          </select>
        </div>
