  ...
  >
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          to="/business"
          :class="getRoute() === 'business' ? 'active' : ''"
          :navText="isRTL ? 'Business' : '영업'"
        >
          <template v-slot:icon>
            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
          </template>
      ...
      <li class="nav-item">
        <sidenav-item
          to="/equipment"
          :class="getRoute() === 'equipment' ? 'active' : ''"
          :navText="isRTL ? 'Equipment' : '설비'"
        >
          <template v-slot:icon>
            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
          </template>
      ...
      <li class="nav-item">
        <sidenav-item
          to="/quality"
          :class="getRoute() === 'quality' ? 'active' : ''"
          :navText="isRTL ? 'Quality' : '품질'"
        >
          <template v-slot:icon>
            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
          </template>
      ...
      <li class="nav-item">
        <sidenav-item
          to="/standard"
          :class="getRoute() === 'standard' ? 'active' : ''"
          :navText="isRTL ? 'Standard' : '기준정보'"
        >
          <template v-slot:icon>
            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
          </template>
